...
# 3. اختيار الموديل (استخدام المسمى الكامل والأكثر توافقاً)
# جربنا نكتبه بالطريقة اللي تطلبها جوجل رسمياً للنسخ المستقرة
model = genai.GenerativeModel(model_name='gemini-1.5-flash')

# 4. ذاكرة المحادثة والترحيب (نفس الأسلوب اللي تحبه بالضبط)
...
# 5. معالجة الردود بأسلوب بوبدر "طبق الأصل"
    ...
    try:
        with st.spinner("أحمد AI يفكّر بعبقرية الصالحي..."):
            ...
            instruction = (
                ...
                "تحدث بلهجة عمانية راقية، ذكية، وفخورة. "
                ...
                "ممنوع الفصحى، كن ذكياً وفطيناً كأنك المبرمج أحمد الصالحي نفسه."
            )
            
            # الطلب باستخدام الموديل
        ...
        # حل أخير لو استمرت المشكلة: إظهار الخطأ بشكل أوضح للمبرمج بوبدر
        st.error(f"علوه يا بوبدر، السيرفر لا زال معاند. جرب تغير اسم الموديل في الكود إلى 'gemini-1.5-flash-latest'. الخطأ: {e}")
